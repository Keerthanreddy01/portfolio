...
export const metadata: Metadata = {
    title: 'Keerthan Reddy | Portfolio',
    description:
        'Personal portfolio of Keerthan Reddy - Full Stack Developer & AI Enthusiast building high-performance web, mobile, and AI-powered digital products.',
};
