            ...
            <div className="flex gap-2 md:gap-5">
                ...
                <div className="">
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        {project.status && (
                            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-sans font-medium bg-primary/10 text-primary border border-primary/20 backdrop-blur-sm">
                    ...
                    {project.sourceCode && (
                        <button
                            ...
                            className="inline-flex items-center gap-1.5 mt-2 mb-1 text-muted-foreground hover:text-primary transition-colors text-sm"
